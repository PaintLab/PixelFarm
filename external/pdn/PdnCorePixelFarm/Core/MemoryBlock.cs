...
namespace PaintDotNet
{
    ...
    public static class PlatformProcessor
    {
        static int cpuCount = 1;
        public static void SetLogicalCpuCount(int c)
        {
            cpuCount = c;
        }
          ...
          IDeferredSerializable
    {
        ...
        public bool AllowWrites
        {
            set
            {
                ...
                PlatformMemory.ProtectBlockLarge(new IntPtr(this.voidStar), (ulong)this.length, true, value);
            }
        }
        ...
        //    PaintDotNet.Threading.ThreadPool threadPool = new PaintDotNet.Threading.ThreadPool(PlatformProcessor.LogicalCpuCount);
        //    ArrayList exceptions = new ArrayList(PlatformProcessor.LogicalCpuCount);
        ...
        //        PixelUtils.ReadFromStream(input, compressedBytes, 0, compressedBytes.Length);
        ...
        //            {
        //                PlatformMemory.Copy((void*)((byte*)this.VoidStar + chunkOffset), (void*)pbSrc, thisChunkSize);
        //            }
        //        }
        //    }
        ...
        //    }
        //}
        public class DeferredFormatter
        {
        }
        ...
        //    PaintDotNet.Threading.ThreadPool threadPool = new PaintDotNet.Threading.ThreadPool(PlatformProcessor.LogicalCpuCount);
        //    ArrayList exceptions = ArrayList.Synchronized(new ArrayList(PlatformProcessor.LogicalCpuCount));
