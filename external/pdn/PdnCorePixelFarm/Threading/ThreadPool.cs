...
namespace PaintDotNet.Threading
{
    ...
    {
        private static ThreadPool global = new ThreadPool(2 * PlatformProcessor.LogicalCpuCount);
        ...
        public void DrainExceptions()
        {
            if (this.exceptions.Count > 0)
            {
                ...
                throw new Exception("Worker thread threw an exception", (Exception)this.exceptions[0]);
            }
        ...
        public ThreadPool()
            : this(PlatformProcessor.LogicalCpuCount)
        {
        }
