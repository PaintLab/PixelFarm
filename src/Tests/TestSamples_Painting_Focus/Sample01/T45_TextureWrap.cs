...
{
    [Info(OrderCode = "045", AvailableOn = AvailableOn.GLES)]
    ...
    [Info(OrderCode = "045")]
    [Info("T45_1_TextureWrap")]
    public class T45_1_TextureWrap : DemoBase
    {
        bool isGLInit;
        protected override void OnReadyForInitGLShaderProgram()
        {
        ...
        protected override void OnGLRender(object sender, EventArgs args)
        {
            ...
            //glVertexAttribPointer(mPositionLoc, 4, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), vertices);
            GL.VertexAttribPointer(mPositionLoc, 4, VertexAttribPointerType.Float, false, 6 * sizeof(float), 0);
            //glEnableVertexAttribArray(mPositionLoc);
            GL.EnableVertexAttribArray(mPositionLoc);
            //// Load the texture coordinate
            //glVertexAttribPointer(mTexCoordLoc, 2, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), vertices + 4); 
