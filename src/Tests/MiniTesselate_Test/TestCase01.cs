...
namespace MatterHackers.Agg.Tests
{
    ...
    public class TesselatorTests
    {
        ...
        public void CombineCallBack(double v0, double v1, double v2,
            ...
            out int outData)
        {
            ...
            Assert.AreEqual(GetNextOutputAsInt(), combinePars.d3);
            Assert.AreEqual(GetNextOutputAsDouble(), combinePars.w0, error);
            Assert.AreEqual(GetNextOutputAsDouble(), combinePars.w1, error);
            Assert.AreEqual(GetNextOutputAsDouble(), combinePars.w2, error);
            Assert.AreEqual(GetNextOutputAsDouble(), combinePars.w3, error);
