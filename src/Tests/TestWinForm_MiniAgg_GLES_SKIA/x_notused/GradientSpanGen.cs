...
//                            {
//                                //generate next part
//                                nextPart.GenerateColors(outputColors, startIndex, scanline_x, scanline_y, spanLen);
//                                return;
//                            }
//                        }
//                        else
...
//                    //
//                }
//                outputColors[startIndex++] = _colorsProvider.GetColor(d);
//                _interpolator.Next();//**
//                scanline_x++;
//            }
//            while (--spanLen != 0);
...
//    }
    ...
    //    public Color GetColor(float v) => _c1.CreateGradient(_c2, (float)(v) / (float)(_gradientSteps - 1));
