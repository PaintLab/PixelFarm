...
#if DEBUG
                wb.dbugDrawLineAa(100, y, 200, y + 100, PixelFarm.DrawingBuffer.ColorInt.FromArgb(255, 255, 0, 0));
                wb.dbugDrawLineAa(100, y + 100, 200, y + 0, PixelFarm.DrawingBuffer.ColorInt.FromArgb(255, 0, 0, 255)); //blue 
#endif
