...
namespace OpenTK.Platform
{
    ...
    public abstract class GLExtensionLoader
    {
        public abstract int LoadDelegates();
        public abstract bool SupportFuncName(string funcName);
    }
    ...
    public static class Utilities
    {
        ...
        /// </remarks>
        internal static void LoadExtensions(GLExtensionLoader glExtLoader)
        {
            ...
            time.Reset();
            time.Start();
            int supported = glExtLoader.LoadDelegates();
            time.Stop();
            ...
            //Type extensions_class = delegatesNestedType;
            //if (extensions_class == null)
            //    throw new InvalidOperationException("The specified type does not have any loadable extensions.");

            ////get all delegate field from extension class
            ...
            //{
            //    //load delegate that match with the field name 
