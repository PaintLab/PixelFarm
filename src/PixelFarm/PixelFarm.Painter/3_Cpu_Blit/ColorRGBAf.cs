...
namespace PixelFarm.CpuBlit
{
    ...
    public struct ColorRGBAf
    {
        ...
        public int Red0To255 => AggMath.uround_f(red * (float)BASE_MASK);

        public int Green0To255 => AggMath.uround_f(green * (float)BASE_MASK);

        public int Blue0To255 => AggMath.uround_f(blue * (float)BASE_MASK);

        public int Alpha0To255 => AggMath.uround_f(alpha * (float)BASE_MASK);
