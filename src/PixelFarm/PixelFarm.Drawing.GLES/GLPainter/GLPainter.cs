...
#endif
                CpuBlit.BitmapAtlas.BitmapAtlasItem item = _msdfGen.GenerateMsdfTexture(vxs);
                var spriteTextureMap = new CpuBlit.BitmapAtlas.SpriteTextureMapData<MemBitmap>(item.Left, item.Top, item.Width, item.Height);
