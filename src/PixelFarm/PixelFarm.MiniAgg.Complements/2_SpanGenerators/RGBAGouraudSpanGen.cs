...
namespace PixelFarm.CpuBlit
{
    ...
    public sealed class RGBAGouraudSpanGen : GouraudSpanGen, ISpanGenerator
    {
        ...
        public void GenerateColors(Color[] outputColors, int startIndex, int x, int y, int len)
        {
            ...
            if (nlen <= 0) nlen = 1;
            var line_r = new PixelFarm.CpuBlit.Transform.LineInterpolatorDDA(pc1.m_r, pc2.m_r, nlen, 14);
            var line_g = new PixelFarm.CpuBlit.Transform.LineInterpolatorDDA(pc1.m_g, pc2.m_g, nlen, 14);
            var line_b = new PixelFarm.CpuBlit.Transform.LineInterpolatorDDA(pc1.m_b, pc2.m_b, nlen, 14);
            var line_a = new PixelFarm.CpuBlit.Transform.LineInterpolatorDDA(pc1.m_a, pc2.m_a, nlen, 14);
