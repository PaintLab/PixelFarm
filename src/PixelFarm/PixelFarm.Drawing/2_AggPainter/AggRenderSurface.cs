...
namespace PixelFarm.CpuBlit
{
    public sealed partial class AggRenderSurface
    {
        ...
        //
        public CartesRect GetClippingRect() => ScanlineRasterizer.GetVectorClipBox();
        public void SetClippingRect(CartesRect rect)
        {
            rect.IntersectWithRectangle(new CartesRect(0, 0, this.Width, this.Height));
