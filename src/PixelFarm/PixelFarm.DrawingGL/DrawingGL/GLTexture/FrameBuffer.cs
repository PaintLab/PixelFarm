...
namespace PixelFarm.DrawingGL
{
    ...
    public class FrameBufferCreationParameters
    {
        ...
        public TextureMagFilter magFilter = TextureMagFilter.Linear; //default
        public TextureMinFilter minFilter = TextureMinFilter.LinearMipmapNearest; //default
    }
    ...
    public class FrameBuffer : IDisposable
    {
        ...
        void InitFrameBuffer(FrameBufferCreationParameters creationParams)
        {
            ...
            GL.TexImage2D((TextureTarget2d)TextureTarget.Texture2D, 0, (TextureComponentCount)creationParams.pixelInternalFormat, w, h, 0, creationParams.pixelFormat, PixelType.UnsignedByte, IntPtr.Zero);
