...
//    public sealed class rasterizer_compound_aa : IRasterizer
//    {
//        enum LayerOrder
//        {
//            //layer_order_e
...
//            {
//                Sort(ref dataToSort, 0, (int)(dataToSort.Count - 1));
//            }

//            static void Sort(ref ArrayListRangeAdaptor dataToSort, int beg, int end)
//            {
//                if (end == beg)
//                {
//                    return;
...
//                else
//                {
//                    int pivot = GetPivotPoint(ref dataToSort, beg, end);
//                    if (pivot > beg)
//                    {
//                        Sort(ref dataToSort, beg, pivot - 1);
//                    }

//                    if (pivot < end)
//                    {
//                        Sort(ref dataToSort, pivot + 1, end);
//                    }
//                }
//            }

//            static int GetPivotPoint(ref ArrayListRangeAdaptor dataToSort, int begPoint, int endPoint)
//            {
//                int pivot = begPoint;
//                int m = begPoint + 1;
//                int n = endPoint;
