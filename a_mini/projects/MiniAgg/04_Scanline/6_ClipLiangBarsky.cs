...
namespace PixelFarm.Agg
{
    ...
    static class ClipLiangBarsky
    {
        ...
        // 
        //template<class T>
        public static int Flags(int x, int y, RectangleInt clip_box)
        {
        ...
        public static int GetFlagsX(int x, RectangleInt clip_box)
        {
            return ((x > clip_box.Right ? 1 : 0) | ((x < clip_box.Left ? 1 : 0) << 2));
        }

        public static int GetFlagsY(int y, RectangleInt clip_box)
        {
