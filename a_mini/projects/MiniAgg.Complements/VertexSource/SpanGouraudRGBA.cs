...
namespace PixelFarm.Agg.VertexSource
{
    ...
    public sealed class SpanGouraudRGBA : SpanGourand, ISpanGenerator
    {
        ...
        public void Generate(ColorRGBA[] span, int spanIndex, int x, int y, int len)
        {
            ...
            var r = new PixelFarm.Agg.Transform.LinearInterpolatorDDA(pc1.m_r, pc2.m_r, nlen, 14);
            var g = new PixelFarm.Agg.Transform.LinearInterpolatorDDA(pc1.m_g, pc2.m_g, nlen, 14);
            var b = new PixelFarm.Agg.Transform.LinearInterpolatorDDA(pc1.m_b, pc2.m_b, nlen, 14);
            var a = new PixelFarm.Agg.Transform.LinearInterpolatorDDA(pc1.m_a, pc2.m_a, nlen, 14);
