...
namespace PixelFarm.DrawingBuffer
{
    ...
    public static partial class WriteableBitmapExtensions
    {
        ...
        public static BmpBuffer Convolute(this BmpBuffer bmp, int[,] kernel)
        {
        ...
        /// <returns>A new WriteableBitmap that is a filtered version of the input.</returns>
        public static BmpBuffer Convolute(this BmpBuffer bmp, int[,] kernel, int kernelFactorSum, int kernelOffsetSum)
        {
            ...
            using (var srcContext = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
                ...
                BmpBuffer result = BitmapFactory.New(w, h);
        ...
        public static BmpBuffer Invert(this BmpBuffer bmp)
        {
            using (var srcContext = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
        ...
        public static BmpBuffer Gray(this BmpBuffer bmp)
        {
            using (var context = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
                ...
                BmpBuffer result = BitmapFactory.New(nWidth, nHeight);
        ...
        public static BmpBuffer AdjustContrast(this BmpBuffer bmp, double level)
        {
        ...
        /// <returns>The new WriteableBitmap.</returns>
        public static BmpBuffer AdjustBrightness(this BmpBuffer bmp, int nLevel)
        {
            using (var context = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
                int nWidth = context.Width;
        ...
        /// <returns>The new WriteableBitmap.</returns>
        public static BmpBuffer AdjustGamma(this BmpBuffer bmp, double value)
        {
            using (var context = bmp.GetBitmapContext(ReadWriteMode.ReadOnly))
            {
                int nWidth = context.Width;
