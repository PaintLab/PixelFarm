...
namespace PixelFarm.DrawingBuffer
{
    ...
    public static partial class WriteableBitmapExtensions
    {
        ...
        public static void DrawPolyline(this BmpBuffer bmp, int[] points, ColorInt color)
        {
        ...
        /// <param name="points">The points of the polyline in x and y pairs, therefore the array is interpreted as (x1, y1, x2, y2, ..., xn, yn).</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawPolyline(this BmpBuffer bmp, int[] points, int color)
        {
        ...
        /// <param name="points">The points of the polyline in x and y pairs, therefore the array is interpreted as (x1, y1, x2, y2, ..., xn, yn).</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawPolylineAa(this BmpBuffer bmp, int[] points, ColorInt color)
        {
        ...
        /// <param name="points">The points of the polyline in x and y pairs, therefore the array is interpreted as (x1, y1, x2, y2, ..., xn, yn).</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawPolylineAa(this BmpBuffer bmp, int[] points, int color)
        {
            using (var context = bmp.GetBitmapContext())
            {
                // Use refs for faster access (really important!) speeds up a lot!
        ...
        public static void DrawTriangle(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int x3, int y3, ColorInt color)
        {
        ...
        /// <param name="y3">The y-coordinate of the 3rd point.</param>
        /// <param name="color">The color.</param>
        public static void DrawTriangle(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int x3, int y3, int color)
        {
            using (var context = bmp.GetBitmapContext())
            {
                // Use refs for faster access (really important!) speeds up a lot!
        ...
        /// <param name="color">The color.</param>
        public static void DrawQuad(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, ColorInt color)
        {
        ...
        /// <param name="y4">The y-coordinate of the 4th point.</param>
        /// <param name="color">The color.</param>
        public static void DrawQuad(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int color)
        {
            using (var context = bmp.GetBitmapContext())
            {
                // Use refs for faster access (really important!) speeds up a lot!
        ...
        /// <param name="color">The color.</param>
        public static void DrawRectangle(this BmpBuffer bmp, int x1, int y1, int x2, int y2, ColorInt color)
        {
        ...
        /// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
        /// <param name="color">The color.</param>
        public static void DrawRectangle(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int color)
        {
            using (var context = bmp.GetBitmapContext())
            {
                // Use refs for faster access (really important!) speeds up a lot!
        ...
        /// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawEllipse(this BmpBuffer bmp, int x1, int y1, int x2, int y2, ColorInt color)
        {
        ...
        /// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawEllipse(this BmpBuffer bmp, int x1, int y1, int x2, int y2, int color)
        {
        ...
        /// <param name="color">The color for the line.</param>
        public static void DrawEllipseCentered(this BmpBuffer bmp, int xc, int yc, int xr, int yr, ColorInt color)
        { 
        ...
        /// <param name="yr">The radius of the ellipse in y-direction.</param>
        /// <param name="color">The color for the line.</param>
        public static void DrawEllipseCentered(this BmpBuffer bmp, int xc, int yc, int xr, int yr, int color)
        {
            // Use refs for faster access (really important!) speeds up a lot!
            using (var context = bmp.GetBitmapContext())
            {
