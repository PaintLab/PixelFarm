...
namespace WinFormGdiPlus
{
    ...
    struct LockBmp : IDisposable
    {
        ...
        PixelFarm.DrawingBuffer.BmpBuffer _writeableBitmap;
        ...
        public PixelFarm.DrawingBuffer.BmpBuffer GetWritableBitmap()
        {
            ...
            return _writeableBitmap = new PixelFarm.DrawingBuffer.BmpBuffer(_bmp.Width, _bmp.Height, buffer);
        }
