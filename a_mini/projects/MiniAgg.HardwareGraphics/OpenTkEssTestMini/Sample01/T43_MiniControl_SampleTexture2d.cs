...
namespace OpenTkEssTest
{
    ...
    public class T43_MiniControl_SampleTexture2dDemo : DemoBase
    {
        ...
        public override void Init()
        {
            ...
            {
                T43_MiniControl_SampleTexture2d tt = new T43_MiniControl_SampleTexture2d();
    ...
    public class T43_MiniControl_SampleTexture2d 
    {
        ...
        public T43_MiniControl_SampleTexture2d()
        {
