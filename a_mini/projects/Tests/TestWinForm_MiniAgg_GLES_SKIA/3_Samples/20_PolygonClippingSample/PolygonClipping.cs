...
namespace PixelFarm.Agg.Sample_PolygonClipping
{
    ...
    public class PolygonClippingDemo : DemoBase
    {
                ...
                case PolygonExampleSet.TwoSimplePaths:
                    {
                        ...
                        ps2.CloseFigure();
                        p.FillColor = AggColorExtensions.Make(0f, 0f, 0f, 0.1f);
                        p.Fill(ps1.MakeVertexSnap());
                        p.FillColor = AggColorExtensions.Make(0f, 0.6f, 0f, 0.1f);
                ...
                case PolygonExampleSet.GBAndArrow:
                    {
                        ...
                        p.FillColor = AggColorExtensions.Make(0f, 0.5f, 0.5f, 0.1f);
                        p.Fill(trans_arrows);
                ...
                case PolygonExampleSet.GBAndSpiral:
                    {
                        ...
                        p.FillColor = AggColorExtensions.Make(0.0f, 0.5f, 0.5f, 0.1f);// XUolorRXBAf.MakeColorRGBA(0.0f, 0.5f, 0.5f, 0.1f);
                        p.Fill(stroke_vxs);
        ...
        void CreateAndRenderCombined(CanvasPainter p, VertexStoreSnap ps1, VertexStoreSnap ps2)
        {
            ...
            if (combined != null)
            {
                p.FillColor = AggColorExtensions.Make(0.5f, 0.0f, 0f, 0.5f);
