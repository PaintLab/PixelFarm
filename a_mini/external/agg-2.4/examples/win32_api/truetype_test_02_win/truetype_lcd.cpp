...
public:
    ...
    virtual void on_draw()
    {
        ...
        {
            y  = draw_text(ras, sl, ren_solid, typeface, false, text1, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid, typeface, true,  text2, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid, typeface, false, text3, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid, typeface, true,  text4, 10, y, k*12, 1); 
            y -= 7 + k*12;
        }
        else
        {
            y  = draw_text(ras, sl, ren_solid_lcd, typeface, false, text1, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid_lcd, typeface, true,  text2, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid_lcd, typeface, false, text3, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, ren_solid_lcd, typeface, true,  text4, 10, y, k*12, 3); 
            y -= 7 + k*12;
        }
...
/*
        ...
        if(m_grayscale.status())
        {
            for(int i = 0; i < 30; ++i)
            {
                draw_text(ras, sl, ren_solid, typeface, false, pangram, 10+i/10., y, k*11, 1);  y -= k*11;
            }
        }
        else
        {
            for(int i = 0; i < 30; ++i)
            {
                draw_text(ras, sl, ren_solid_lcd, typeface, false, pangram, 10+i/10., y, k*11, 3);  y -= k*11;
            }
        }
*/
...
/*
        ...
        if(m_grayscale.status())
        {
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*10, 1); y -= 3+k*10;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*11, 1); y -= 3+k*11;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*12, 1); y -= 3+k*12;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*13, 1); y -= 3+k*13;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*14, 1); y -= 3+k*14;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*15, 1); y -= 3+k*15;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*16, 1); y -= 3+k*16;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*17, 1); y -= 3+k*17;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*18, 1); y -= 3+k*18;
            draw_text(ras, sl, ren_solid, typeface, true, pangram, 10, y, k*19, 1); y -= 3+k*19;
        }
        else
        {
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*10, 3); y -= 3+k*10;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*11, 3); y -= 3+k*11;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*12, 3); y -= 3+k*12;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*13, 3); y -= 3+k*13;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*14, 3); y -= 3+k*14;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*15, 3); y -= 3+k*15;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*16, 3); y -= 3+k*16;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*17, 3); y -= 3+k*17;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*18, 3); y -= 3+k*18;
            draw_text(ras, sl, ren_solid_lcd, typeface, true, pangram, 10, y, k*19, 3); y -= 3+k*19;
        }
*/
